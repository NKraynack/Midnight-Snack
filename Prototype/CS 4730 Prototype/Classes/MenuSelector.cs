...
namespace CS_4730_Prototype
{
    public class MenuSelector : GameObject
    {
        ...
        public MenuSelector(Vector2 playerPos, int width, int height) : base(playerPos, width, height)
        {
            Position = playerPos;
            Position.X += 70;
            Position.Y += 15;
        ...
        public void SelectAction(Controls controls)
        {
            ...
            if (controls.onPress(Keys.Space, Buttons.A))
            {
                ...
                else if(selectorRow == 1 && !player.HasInteractedThisTurn())
                {
                ...
                else if(selectorRow == 2)
                {
                    ...
                    player.SetInteractedThisTurn(false);
